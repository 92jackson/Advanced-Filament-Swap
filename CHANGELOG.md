...
-   Added Firefox MV3 compliance: defined add-on ID and data collection permissions.
-   Removed dynamic innerHTML usage in Settings to satisfy store requirements.
